...
(let ((monokai-blue-light "#89BDFF")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-string-face ((t (:foreground ,monokai-yellow-light))))
   `(font-lock-function-name-face ((t (:foreground ,monokai-green))))
   `(font-lock-keyword-face ((t (:foreground ,monokai-yellow))))
   `(font-lock-string-face ((t (:foreground ,monokai-yellow-light))))
